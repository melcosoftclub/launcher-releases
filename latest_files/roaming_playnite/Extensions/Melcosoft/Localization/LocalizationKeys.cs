namespace Melcosoft.Localization
{
    ...
    {
        public const string InstallGame = "LOCMelcosoftInstallGame";
        public const string UninstallGame = "LOCMelcosoftUninstallGame";
        public const string RepairGameFiles = "LOCMelcosoftRepairGameFiles";
        public const string VerifyGameFiles = "LOCMelcosoftVerifyGameFiles";

        public const string InstallingGame = "LOCMelcosoftInstallingGame";
        public const string UninstallingGame = "LOCMelcosoftUninstallingGame";
        public const string UpdatingGame = "LOCMelcosoftUpdatingGame";
        ...
        public const string Updating = "LOCMelcosoftUpdating";
        public const string Repairing = "LOCMelcosoftRepairing";
        ...
        public const string Cancelling = "LOCMelcosoftCancelling";

        public const string DownloadingFiles = "LOCMelcosoftDownloadingFiles";
        public const string ExtractingFiles = "LOCMelcosoftExtractingFiles";
        public const string ValidatingFiles = "LOCMelcosoftValidatingFiles";
        public const string RepairingFiles = "LOCMelcosoftRepairingFiles";

        public const string FinalizingInstallation = "LOCMelcosoftFinalizingInstallation";
        public const string PreparingDownload = "LOCMelcosoftPreparingDownload";

        public const string InstallGameFailed = "LOCMelcosoftInstallGameFailed";
        public const string UninstallGameFailed = "LOCMelcosoftUninstallGameFailed";
        public const string UpdateGameFailed = "LOCMelcosoftUpdateGameFailed";
        public const string RepairGameFailed = "LOCMelcosoftRepairGameFailed";
        public const string VerifyGameFailed = "LOCMelcosoftVerifyGameFailed";
        public const string SyncGameFailed = "LOCMelcosoftSyncGameFailed";

        public const string InstallGameCancelled = "LOCMelcosoftInstallGameCancelled";
        public const string UninstallGameCancelled = "LOCMelcosoftUninstallGameCancelled";
        ...
        public const string Cancelled = "LOCMelcosoftCancelled";
        public const string Failed = "LOCMelcosoftFailed";
        public const string Queued = "LOCMelcosoftQueued";
        public const string Paused = "LOCMelcosoftPaused";

        public const string ContactSupport = "LOCMelcosoftContactSupport";

        public const string Play = "LOCMelcosoftPlay";
        public const string Cancel = "LOCMelcosoftCancel";
        public const string Close = "LOCMelcosoftClose";
        public const string Apply = "LOCMelcosoftApply";
        ...
        public const string SyncCreatedGames = "LOCMelcosoftSyncCreatedGames";
        public const string SyncUpdatedGames = "LOCMelcosoftSyncUpdatedGames";
